        ...
        <>
            <div className="w-full h-full bg-white-200 shadow">
                <div className="flex flex-no-wrap">
                    <div className="absolute lg:relative h-screen shadow bg-black-100 hidden lg:block" style={{ width: "350px", backgroundColor: "black", color: "white" }}>
                        ...
                        <ul aria-orientation="vertical" className="ms-5 mt-5 py-6">
                            ...
                            >
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-2">Approved Labs</span>
                                </div>
                            </li>
                            <li
                                    ...
                                    <ul aria-orientation="vertical" className="mt-5 py-6">
                                        ...
                                        >
                                            <div className="flex items-center">
                                                ...
                                                <span className="ml-2 xl:text-base md:text-2xl text-base">Labs Requests</span>
                                            </div>
                                        </li>
                                        <li
                                            className="pl-6 cursor-pointer text-white-600 text-md leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none"
                                        ...
                                        >
                                            <div className="flex items-center">
                                                ...
                                                <span className="ml-2 xl:text-base md:text-2xl text-base">Tests Requests</span>
                                            </div>
                                        </li>
                                        <li
                                            className="pl-6 cursor-pointer text-white-600 text-md leading-3 tracking-normal mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none"
                                        ...
                                        >
                                            <div className="flex items-center">
                                                ...
                                                <span className="ml-2 xl:text-base md:text-2xl text-base">Approved Labs</span>
                                            </div>
                                        </li>
                                        <li
                                            className="pl-6 cursor-pointer text-white-600 text-md leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none"
                                        ...
                                        >
                                            <div className="flex items-center">
                                                ...
                                                <span className="ml-2 xl:text-base md:text-2xl text-base">Approved Tests</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                <div className="w-full">
                                    <div className="flex justify-center mb-4 w-full px-6">
                                        <div className="relative w-full">
                                            ...
                                            <input className="bg-gray-200 focus:outline-none rounded w-full text-md text-white-500  pl-10 py-2" type="text" placeholder="Search" />
                                        </div>
                                    </div>
                                    <div className="border-t border-gray-300">
                                        <div className="w-full flex items-center justify-between px-6 pt-1">
                                            <div className="flex items-center">
                                                ...
                                                <p className="md:text-xl text-white-800 text-base leading-4 ml-2">Admin Name</p>
                                            </div>
                                            <ul className="flex">
                    ...
                    <div className="w-full">
                        ...
                        <nav className="h-16 flex items-center lg:items-stretch justify-end lg:justify-between bg-white shadow relative z-10">
                            <div className="hidden lg:flex w-full pr-6 shadow" style={{ backgroundColor: "white", border: "1px solid black" }}>
                                {/* search bar */}
                                <div className="w-1/2 h-full hidden lg:flex items-center pl-6 pr-24">
                                    <div className="relative w-full">
                                        ...
                                        <input className="border border-gray-100 focus:outline-none focus:border-indigo-700 rounded w-full text-md text-white-500 bg-gray-100 pl-12 py-2" type="text" placeholder="Search" />
                                    </div>
                                </div>
                                <div className="w-1/2 hidden lg:flex">
                                    <div className="w-full flex items-center pl-8 justify-end">
                                        ...
                                        <div className="h-full w-20 flex items-center justify-center border-r border-l">
                                            <div className="relative cursor-pointer text-white-600">
                                        ...
                                        {/* msgs */}
                                        <div className="h-full w-20 flex items-center justify-center border-r mr-4 cursor-pointer text-white-600">
                                        ...
                                        <div className="flex items-center relative cursor-pointer" onClick={() => setProfile(!profile)}>
                                            <div className="rounded-full">
                                                {profile ? (
                                                    <ul className="p-2 w-full border-r bg-white absolute rounded left-0 shadow mt-12 sm:mt-16 ">
                                                        <li className="flex w-full justify-between text-white-600 hover:text-indigo-700 cursor-pointer items-center">
                                                            <div className="flex items-center">
                                                        ...
                                                        <li className="flex w-full justify-between text-white-600 hover:text-indigo-700 cursor-pointer items-center mt-2">
                                                            <div className="flex items-center">
                                            ...
                                            <p className="text-white-800 text-md mx-3">Admin Name</p>
                                            <div className="cursor-pointer text-white-600">
                            ...
                            <div className="text-white-600 mr-8 visible lg:hidden relative" onClick={() => setShow(!show)}>
                                {show ? (
                                    " "
                                ) : (
