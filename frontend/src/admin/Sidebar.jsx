...
export default function Sidebar() 
{
    ...
    const renderComponent = () => {
        if (selectedComponent === 'labs') {
            return <LabReq />;}
        // } else if (selectedComponent === 'tests') {
        //     return <TestsReq />;
        // } else if (selectedComponent === 'approvedLabs') {
        //     return <ApprovedLabs />;
        // } else if (selectedComponent === 'approvedTests') {
                ...
                <div className="flex flex-no-wrap">
                    <div className="absolute lg:relative w-64 h-screen shadow bg-gray-100 hidden lg:block">
                        ...
                        <ul aria-orientation="vertical" className=" py-6">
                            <li
                                className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal pb-4 pt-5 text-indigo-700 focus:text-indigo-700 focus:outline-none"
                            ...
                            >
                                <Link className="flex items-center">
                                    ...
                                    <span className="ml-2">Labs Requests</span>
                                </Link>
                            </li>
                            <li
                                ...
                                onClick={() => handleComponentClick('tests')}
                            >
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-2">Tests Requests</span>
                                </div>
                            </li>
                            <li
                                    ...
                                    <div className="border-t border-gray-300">
                                        <div className="w-full flex items-center justify-between px-6 pt-1">
                                            <div className="flex items-center">
                                                ...
                                                <p className="md:text-xl text-gray-800 text-base leading-4 ml-2">Admin Name</p>
                                            </div>
                                            <ul className="flex">
                                ...
                                <div className="w-1/2 hidden lg:flex">
                                    <div className="w-full flex items-center pl-8 justify-end">
                                        ...
                                        <div className="flex items-center relative cursor-pointer" onClick={() => setProfile(!profile)}>
                                            ...
                                            <p className="text-gray-800 text-sm mx-3">Admin Name</p>
