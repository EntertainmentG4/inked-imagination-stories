    ...
    <>
      {categories.map((data) => (
        <NavLink
          ...
          className="sm:w-60 sm:h-full pb-2 bg-gray-700 border w-40 h-40 shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] border-gray-400 transition-all duration-200 rounded-lg cursor-pointer backdrop-filter backdrop-blur-md hover:bg-gray-600 hover:bg-opacity-60 bg-opacity-60"
        >
          ...
          <p className="hidden mx-4 text-sm text-gray-100 sm:block">
            {data.description}
          </p>
        </NavLink>
      ))}
